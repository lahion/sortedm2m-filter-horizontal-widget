...
var OrderedSelectFilter = {
    init: function(field_id, field_name, is_stacked) {
        ...
        if (!is_stacked) {
            ...
            var j_from_box = jQuery(from_box);
            var j_to_box = jQuery(to_box);
            var resize_filters = function() { j_to_box.height(jQuery(filter_p).outerHeight() + j_from_box.outerHeight()); };
    ...
    refresh_icons: function(field_id) {
        var from = jQuery('#' + field_id + '_from');
        var to = jQuery('#' + field_id + '_to');
        ...
        jQuery('#' + field_id + '_add_link').toggleClass('active', is_from_selected);
        jQuery('#' + field_id + '_remove_link').toggleClass('active', is_to_selected);
        // Active if the corresponding box isn't empty
        jQuery('#' + field_id + '_add_all_link').toggleClass('active', is_from_non_empty);
        jQuery('#' + field_id + '_remove_all_link').toggleClass('active', is_to_non_empty);
    },
